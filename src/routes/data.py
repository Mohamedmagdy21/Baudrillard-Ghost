...
from src.models.db_schema import DataChunk,Asset
...
async def upload_data(request:Request,project_id:str,file: UploadFile,app_settings: Settings = Depends(get_settings)):
    ...
    file_path,file_id=data_controller.generate_unique_filepath(orig_name=file.filename,project_id=project_id)
    ...
    return JSONResponse(
        content={
            ...
            "file_id": asset_resource.asset_name,
...
async def process_endpoint(request:Request,project_id:str,process_request:ProcessRequest):
    ...
    for asset_id,file_id in project_file_ids.items():
        ...
        num_records +=  await chunk_model.insert_chunks(chunks=file_chunks_records)
        num_files+=1
    return JSONResponse(
        content={
